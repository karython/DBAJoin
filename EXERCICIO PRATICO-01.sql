...
delete from tipo_cliente where id_tipo = 3;
delete from tipo_cliente where id_tipo = 4;
...
alter table clientes drop column id_tipo;

desc tipo_cliente;

alter table clientes 
add constraint fk_cliente_tipo
foreign key (tipo) references tipo_cliente (id_tipo);
...
select clienteID, nome, tipo from clientes where nome like '%a';
update clientes set tipo = 1 where ClienteID = 1;
update clientes set tipo = 1 where ClienteID = 4;
update clientes set tipo = 1 where ClienteID = 5;
update clientes set tipo = 1 where ClienteID = 6;
update clientes set tipo = 1 where ClienteID = 8;
update clientes set tipo = 1 where ClienteID = 11;
update clientes set tipo = 1 where ClienteID = 12;
update clientes set tipo = 1 where ClienteID = 13;
update clientes set tipo = 1 where ClienteID = 14;
update clientes set tipo = 1 where ClienteID = 16;
update clientes set tipo = 1 where ClienteID = 18;
update clientes set tipo = 1 where ClienteID = 21;
update clientes set tipo = 1 where ClienteID = 22;
update clientes set tipo = 1 where ClienteID = 24;
update clientes set tipo = 1 where ClienteID = 25;
update clientes set tipo = 1 where ClienteID = 26;
update clientes set tipo = 1 where ClienteID = 29;
update clientes set tipo = 1 where ClienteID = 30;
update clientes set tipo = 1 where ClienteID = 31;
update clientes set tipo = 1 where ClienteID = 33;
update clientes set tipo = 1 where ClienteID = 35;
update clientes set tipo = 1 where ClienteID = 36;
update clientes set tipo = 1 where ClienteID = 39;
update clientes set tipo = 1 where ClienteID = 40;
update clientes set tipo = 1 where ClienteID = 42;
update clientes set tipo = 1 where ClienteID = 44;
update clientes set tipo = 1 where ClienteID = 47;
update clientes set tipo = 1 where ClienteID = 48;
update clientes set tipo = 1 where ClienteID = 50;
update clientes set tipo = 1 where ClienteID = 51;
update clientes set tipo = 1 where ClienteID = 52;
update clientes set tipo = 1 where ClienteID = 56;
update clientes set tipo = 1 where ClienteID = 57;
update clientes set tipo = 1 where ClienteID = 59;
update clientes set tipo = 1 where ClienteID = 62;
update clientes set tipo = 1 where ClienteID = 63;
update clientes set tipo = 1 where ClienteID = 64;
update clientes set tipo = 1 where ClienteID = 66;
update clientes set tipo = 1 where ClienteID = 67;
update clientes set tipo = 1 where ClienteID = 71;
update clientes set tipo = 1 where ClienteID = 72;
update clientes set tipo = 1 where ClienteID = 73;
update clientes set tipo = 1 where ClienteID = 74;
update clientes set tipo = 1 where ClienteID = 76;
update clientes set tipo = 1 where ClienteID = 79;
update clientes set tipo = 1 where ClienteID = 80;
update clientes set tipo = 1 where ClienteID = 81;
update clientes set tipo = 1 where ClienteID = 82;
update clientes set tipo = 1 where ClienteID = 84;
update clientes set tipo = 1 where ClienteID = 86;
update clientes set tipo = 1 where ClienteID = 88;
update clientes set tipo = 1 where ClienteID = 90;

select clienteID, nome, tipo from clientes where nome like '%o';

update clientes set tipo = 2 where ClienteID = 15;
update clientes set tipo = 2 where ClienteID = 27;
update clientes set tipo = 2 where ClienteID = 37;
update clientes set tipo = 2 where ClienteID = 45;
update clientes set tipo = 2 where ClienteID = 54;
update clientes set tipo = 2 where ClienteID = 61;
update clientes set tipo = 2 where ClienteID = 69;
update clientes set tipo = 2 where ClienteID = 77;
update clientes set tipo = 2 where ClienteID = 85;
update clientes set tipo = 2 where ClienteID = 89;
...
select nome,tipo from clientes;

	#7.Com a consulta acima, agora mostre os nomes de clientes que não possuem tipo.

select nome,tipo from clientes where tipo is null;

	#8.Faça uma consulta que mostre os dados do cliente e o nome do tipo em vez do código de tipo.

select Clientes.Nome, Clientes.Email, Clientes.Telefone, tipo_cliente.tipo
from Clientes
inner join tipo_cliente
on clientes.tipo = tipo_cliente.ID_tipo;

desc clientes;
desc tipocliente;

	/*#9.	Os clientes dos Id (5, 9, 10, 20, 25, 40, 43, 89) retornaram e fizeram novas compras, sendo que os clientes de id (5, 25 e 20) 
	compraram cada um 3 produtos no dia 17 de outubro de 2023, os clientes de id (9 e 43) 
	compraram cada um 6 produtos no dia 12 de setembro de 2023, e o cliente de id (10, 40 e 89) 
...
insert into pedidos(DataPedido, ValorTotal, ClienteID) values 
	...
	('2023-10-17',68.00,20),
    ('2023-09-12',38.00,9),
    ('2023-09-12',150.00,43),
    ('2023-10-15',125.00,10),
    ('2023-10-15',25.00,40),
    ('2023-10-15',45.00,89);
    
insert into itenspedido (PedidoID, ProdutoID, Quantidade) values
	(44,1,5),(44,2,1),(44,3,6),
    (45,2,4),(45,1,2),(45,2,5),
    (46,2,4),(46,1,2),(46,2,5),
    (47,2,4),(47,1,2),(47,2,5),(47,2,4),(47,1,2),(47,2,5),
    (48,2,4),(48,1,2),(48,2,5),(48,2,4),(48,1,2),(48,2,5),
    (49,2,4),(49,1,2),(49,2,5),(49,2,4),(49,1,2),(49,2,5),(49,2,4),(49,1,2),(49,2,5),(49,2,4),
    (50,2,4),(50,1,2),(50,2,5),(50,2,4),(50,1,2),(50,2,5),(50,2,4),(50,1,2),(50,2,5),(50,2,4),
    (51,2,4),(51,1,2),(51,2,5),(51,2,4),(51,1,2),(51,2,5),(51,2,4),(51,1,2),(51,2,5),(51,2,4);
