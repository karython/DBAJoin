...
VALUES
    (1, '2023-09-16', 22.99, 1, 3),
    (2, '2023-09-17', 18.75, 2, 2),
    (3, '2023-09-18', 14.99, 3, 4),
    (4, '2023-09-19', 26.50, 4, 1),
    (5, '2023-09-20', 19.99, 5, 2),
    (6, '2023-09-21', 29.99, 6, 3),
    (7, '2023-09-22', 17.75, 7, 2),
    (8, '2023-09-23', 32.50, 8, 1),
    (9, '2023-09-24', 21.99, 9, 4),
    (10, '2023-09-25', 27.75, 10, 1),
    (11, '2023-09-26', 18.50, 11, 2),
    (12, '2023-09-27', 24.99, 12, 3),
    (13, '2023-09-28', 29.75, 13, 1),
    (14, '2023-09-29', 15.99, 14, 2),
    (15, '2023-09-30', 28.50, 15, 5),
    (16, '2023-10-01', 20.99, 1, 2),
    (17, '2023-10-02', 16.75, 2, 3),
    (18, '2023-10-03', 24.50, 3, 1),
    (19, '2023-10-04', 18.99, 4, 4),
    (20, '2023-10-05', 21.75, 5, 2),
    (21, '2023-10-06', 23.99, 6, 3),
    (22, '2023-10-07', 26.50, 7, 1),
    (23, '2023-10-08', 19.99, 8, 2),
    (24, '2023-10-09', 15.75, 9, 3),
    (25, '2023-10-10', 28.50, 10, 1);
...
SELECT CURDATE();
/*2*/
SELECT PedidoID, DataPedido, ValorTotal, ValorTotal * 1.1 AS 'ValorComAumento'
FROM Pedidos;
/*3*/
SELECT PedidoID, DataPedido, ValorTotal, ValorTotal * 1.1 AS 'ValorComAumento', ValorTotal * 0.1 AS 'ValorAcrescido'
FROM Pedidos;

/*4*/
SELECT UPPER(NomeCliente) AS 'NomeEmMaiusculas', LOWER(Email) AS 'EmailEmMinusculas'
FROM Clientes;

/*5*/
SELECT SUBSTRING(NomeCliente, 1, 3) AS 'TresPrimeirasLetrasDoNome', Email
FROM Clientes;

/*6*/
SELECT PedidoID, DataPedido, DATEDIFF(CURDATE(), DataPedido) AS 'DiasAteHoje'
FROM Pedidos;

/*7*/
SELECT PedidoID, DataPedido, DATEDIFF(CURDATE(), DataPedido) AS 'DiasAteHoje', DATE_ADD(CURDATE(), INTERVAL 15 DAY) AS 'DataComAcrescimo'
FROM Pedidos;
