...
CREATE DATABASE exerciciospratico;
...
----------------- EXERCÍCIOS DE SELECT - AULA DO DIA 11/10 ---------------
----- QUESTÃO 01 ----- 
...
----- QUESTÃO 06 -----
SELECT Pedidos.PedidoID, Pedidos.ValorTotal, Clientes.Nome
FROM Pedidos
INNER JOIN Clientes
ON Pedidos.PedidoID = Clientes.ClienteID
...
SELECT Pedidos.PedidoID, ItensPedido.ProdutoID, Clientes.Nome
FROM ItensPedido
INNER JOIN Pedidos
ON ItensPedido.PedidoID = Pedidos.PedidoID
INNER JOIN Clientes
ON Pedidos.CLienteID = Clientes.ClienteID
WHERE Pedidos.pedidoID = 9;
...
----- QUESTÃO 12 -----
SELECT itenspedido.ProdutoID, produtos.NomeProduto, /* itenspedido.PedidoID, */ Pedidos.ClienteID, Clientes.Nome
FROM Pedidos
...
INNER JOIN Produtos
ON ItensPedido.ProdutoID = Produtos.ProdutoID
WHERE Pedidos.DataPedido BETWEEN '2023-09-01' AND '2023-10-29'
LIMIT 7;
...
----- QUESTÃO 17 -----
SELECT ItensPedido.PedidoID, Pedidos.DataPedido, Pedidos.ValorTotal, Produtos.NomeProduto, ItensPedido.Quantidade
FROM ItensPedido
INNER JOIN Pedidos
ON ItensPedido.PedidoID = Pedidos.PedidoID
INNER JOIN Produtos
...
----- QUESTÃO 18 -----
SELECT ItensPedido.PedidoID, Pedidos.DataPedido, Pedidos.ValorTotal, Produtos.NomeProduto, ItensPedido.Quantidade, Clientes.Nome
FROM ItensPedido
INNER JOIN Pedidos
ON ItensPedido.PedidoID = Pedidos.PedidoID
INNER JOIN Produtos
